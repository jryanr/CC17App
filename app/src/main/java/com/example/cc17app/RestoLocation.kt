...
class RestoLocation : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(jollibee, 16f))


        /*val myLoc = LatLng(16.422887885932347, 120.59929234037456)
        val jollibee = LatLng(16.408734862555875, 120.59936980133344)
        return "https://maps.googleapis.com/maps/api/directions/json?origin=$origin&destination=$dest&key=AIzaSyDz_feToTxIFBsysZ2G9zOJ0f6HHdldUTk"*/
    }
}